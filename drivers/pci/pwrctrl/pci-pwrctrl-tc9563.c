...
static int tc9563_pwrctrl_ep_pwr_en(struct pci_pwrctrl_tc9563 *tc9563,
				    enum tc9563_pwrctrl_ports port,
...
static int tc9563_pwrctrl_ep_assert_deassert_reset(struct pci_pwrctrl_tc9563 *tc9563,
						   enum tc9563_pwrctrl_ports port,
