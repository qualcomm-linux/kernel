...
#define CDC_VA_ADPT0_ADPT_CTRL	(0x0800)
#define CDC_VA_ADPT0_ADPT_GAIN_0	(0x0804)
#define CDC_VA_ADPT0_ADPT_GAIN_1	(0x0808)
#define CDC_VA_ADPT0_DH_FSM_CTRL	(0x080C)
#define CDC_VA_ADPT0_CUTOFF_FSM_CTRL_0	(0x0810)
#define CDC_VA_ADPT0_CUTOFF_FSM_CTRL_1	(0x0814)
#define CDC_VA_ADPT0_CUTOFF_FSM_CTRL_2	(0x0818)
#define CDC_VA_ADPT0_CUTOFF_FSM_CTRL_3	(0x081C)
#define CDC_VA_ADPT0_CUTOFF_FSM_CTRL_4	(0x0820)
#define CDC_VA_ADPT0_CUTOFF_FSM_CTRL_5	(0x0824)
#define CDC_VA_ADPT0_CUTOFF_FSM_CTRL_6	(0x0828)
#define CDC_VA_ADPT0_DBG_CTRL		(0x0830)
#define CDC_VA_ADPT0_DBG_PDM_RATE_CTRL_0	(0x0834)
#define CDC_VA_ADPT0_DBG_PDM_RATE_CTRL_1	(0x0838)
#define CDC_VA_ADPT0_SPARE0		(0x083C)
#define CDC_VA_ADPT1_ADPT_CTRL	(0x0880)
#define CDC_VA_ADPT1_ADPT_GAIN_0	(0x0884)
#define CDC_VA_ADPT1_ADPT_GAIN_1	(0x0888)
#define CDC_VA_ADPT1_DH_FSM_CTRL	(0x088C)
#define CDC_VA_ADPT1_CUTOFF_FSM_CTRL_0	(0x0890)
#define CDC_VA_ADPT1_CUTOFF_FSM_CTRL_1	(0x0894)
#define CDC_VA_ADPT1_CUTOFF_FSM_CTRL_2	(0x0898)
#define CDC_VA_ADPT1_CUTOFF_FSM_CTRL_3	(0x089C)
#define CDC_VA_ADPT1_CUTOFF_FSM_CTRL_4	(0x08A0)
#define CDC_VA_ADPT1_CUTOFF_FSM_CTRL_5	(0x08A4)
#define CDC_VA_ADPT1_CUTOFF_FSM_CTRL_6	(0x08A8)
#define CDC_VA_ADPT1_DBG_CTRL		(0x08B0)
#define CDC_VA_ADPT1_DBG_PDM_RATE_CTRL_0	(0x08B4)
#define CDC_VA_ADPT1_DBG_PDM_RATE_CTRL_1	(0x08B8)
#define CDC_VA_ADPT1_SPARE0		(0x08BC)
#define CDC_VA_ADPT2_ADPT_CTRL	(0x0900)
#define CDC_VA_ADPT2_ADPT_GAIN_0	(0x0904)
#define CDC_VA_ADPT2_ADPT_GAIN_1	(0x0908)
#define CDC_VA_ADPT2_DH_FSM_CTRL	(0x090C)
#define CDC_VA_ADPT2_CUTOFF_FSM_CTRL_0	(0x0910)
#define CDC_VA_ADPT2_CUTOFF_FSM_CTRL_1	(0x0914)
#define CDC_VA_ADPT2_CUTOFF_FSM_CTRL_2	(0x0918)
#define CDC_VA_ADPT2_CUTOFF_FSM_CTRL_3	(0x091C)
#define CDC_VA_ADPT2_CUTOFF_FSM_CTRL_4	(0x0920)
#define CDC_VA_ADPT2_CUTOFF_FSM_CTRL_5	(0x0924)
#define CDC_VA_ADPT2_CUTOFF_FSM_CTRL_6	(0x0928)
#define CDC_VA_ADPT2_DBG_CTRL		(0x0930)
#define CDC_VA_ADPT2_DBG_PDM_RATE_CTRL_0	(0x0934)
#define CDC_VA_ADPT2_DBG_PDM_RATE_CTRL_1	(0x0938)
#define CDC_VA_ADPT2_SPARE0		(0x093C)
#define CDC_VA_ADPT3_ADPT_CTRL	(0x0980)
#define CDC_VA_ADPT3_ADPT_GAIN_0	(0x0984)
#define CDC_VA_ADPT3_ADPT_GAIN_1	(0x0988)
#define CDC_VA_ADPT3_DH_FSM_CTRL	(0x098C)
#define CDC_VA_ADPT3_CUTOFF_FSM_CTRL_0	(0x0990)
#define CDC_VA_ADPT3_CUTOFF_FSM_CTRL_1	(0x0994)
#define CDC_VA_ADPT3_CUTOFF_FSM_CTRL_2	(0x0998)
#define CDC_VA_ADPT3_CUTOFF_FSM_CTRL_3	(0x099C)
#define CDC_VA_ADPT3_CUTOFF_FSM_CTRL_4	(0x09A0)
#define CDC_VA_ADPT3_CUTOFF_FSM_CTRL_5	(0x09A4)
#define CDC_VA_ADPT3_CUTOFF_FSM_CTRL_6	(0x09A8)
#define CDC_VA_ADPT3_DBG_CTRL		(0x09B0)
#define CDC_VA_ADPT3_DBG_PDM_RATE_CTRL_0	(0x09B4)
#define CDC_VA_ADPT3_DBG_PDM_RATE_CTRL_1	(0x09B8)
#define CDC_VA_ADPT3_SPARE0		(0x09BC)
#define CDC_VA_INTR_CTRL_CFG		(0x0340)
#define CDC_VA_INTR_CTRL_CLR_COMMIT	(0x0344)
#define CDC_VA_INTR_CTRL_PIN1_MASK0	(0x0360)
#define CDC_VA_INTR_CTRL_PIN1_STATUS0	(0x0368)
#define CDC_VA_INTR_CTRL_PIN1_CLEAR0	(0x0370)
#define CDC_VA_INTR_CTRL_PIN2_MASK0	(0x0380)
#define CDC_VA_INTR_CTRL_PIN2_STATUS0	(0x0388)
#define CDC_VA_INTR_CTRL_PIN2_CLEAR0	(0x0390)
#define CDC_VA_INTR_CTRL_LEVEL0		(0x03C0)
#define CDC_VA_INTR_CTRL_BYPASS0		(0x03C8)
#define CDC_VA_INTR_CTRL_SET0		(0x03D0)



#define VA_MAX_OFFSET				(0x09BC)
...
static const struct reg_default va_defaults[] = {
	...
	//Shikra support additional va registers
	{ CDC_VA_ADPT0_ADPT_CTRL, 0x51},
	{ CDC_VA_ADPT0_ADPT_GAIN_0, 0x11},
	{ CDC_VA_ADPT0_ADPT_GAIN_1, 0x01},
	{ CDC_VA_ADPT0_DH_FSM_CTRL, 0x02},
	{ CDC_VA_ADPT0_CUTOFF_FSM_CTRL_0, 0x77},
	{ CDC_VA_ADPT0_CUTOFF_FSM_CTRL_1, 0x01},
	{ CDC_VA_ADPT0_CUTOFF_FSM_CTRL_2, 0x64},
	{ CDC_VA_ADPT0_CUTOFF_FSM_CTRL_3, 0x00},
	{ CDC_VA_ADPT0_CUTOFF_FSM_CTRL_4, 0x41},
	{ CDC_VA_ADPT0_CUTOFF_FSM_CTRL_5, 0x04},
	{ CDC_VA_ADPT0_CUTOFF_FSM_CTRL_6, 0x01},
	{ CDC_VA_ADPT0_DBG_CTRL, 0x00},
	{ CDC_VA_ADPT0_DBG_PDM_RATE_CTRL_0, 0x45},
	{ CDC_VA_ADPT0_DBG_PDM_RATE_CTRL_1, 0x01},
	{ CDC_VA_ADPT0_SPARE0, 0x00},
	{ CDC_VA_ADPT1_ADPT_CTRL, 0x51},
	{ CDC_VA_ADPT1_ADPT_GAIN_0, 0x11},
	{ CDC_VA_ADPT1_ADPT_GAIN_1, 0x01},
	{ CDC_VA_ADPT1_DH_FSM_CTRL, 0x02},
	{ CDC_VA_ADPT1_CUTOFF_FSM_CTRL_0, 0x77},
	{ CDC_VA_ADPT1_CUTOFF_FSM_CTRL_1, 0x01},
	{ CDC_VA_ADPT1_CUTOFF_FSM_CTRL_2, 0x64},
	{ CDC_VA_ADPT1_CUTOFF_FSM_CTRL_3, 0x00},
	{ CDC_VA_ADPT1_CUTOFF_FSM_CTRL_4, 0x41},
	{ CDC_VA_ADPT1_CUTOFF_FSM_CTRL_5, 0x04},
	{ CDC_VA_ADPT1_CUTOFF_FSM_CTRL_6, 0x01},
	{ CDC_VA_ADPT1_DBG_CTRL, 0x00},
	{ CDC_VA_ADPT1_DBG_PDM_RATE_CTRL_0, 0x45},
	{ CDC_VA_ADPT1_DBG_PDM_RATE_CTRL_1, 0x01},
	{ CDC_VA_ADPT1_SPARE0, 0x00},
	{ CDC_VA_ADPT2_ADPT_CTRL, 0x51},
	{ CDC_VA_ADPT2_ADPT_GAIN_0, 0x11},
	{ CDC_VA_ADPT2_ADPT_GAIN_1, 0x01},
	{ CDC_VA_ADPT2_DH_FSM_CTRL, 0x02},
	{ CDC_VA_ADPT2_CUTOFF_FSM_CTRL_0, 0x77},
	{ CDC_VA_ADPT2_CUTOFF_FSM_CTRL_1, 0x01},
	{ CDC_VA_ADPT2_CUTOFF_FSM_CTRL_2, 0x64},
	{ CDC_VA_ADPT2_CUTOFF_FSM_CTRL_3, 0x00},
	{ CDC_VA_ADPT2_CUTOFF_FSM_CTRL_4, 0x41},
	{ CDC_VA_ADPT2_CUTOFF_FSM_CTRL_5, 0x04},
	{ CDC_VA_ADPT2_CUTOFF_FSM_CTRL_6, 0x01},
	{ CDC_VA_ADPT2_DBG_CTRL, 0x00},
	{ CDC_VA_ADPT2_DBG_PDM_RATE_CTRL_0, 0x45},
	{ CDC_VA_ADPT2_DBG_PDM_RATE_CTRL_1, 0x01},
	{ CDC_VA_ADPT2_SPARE0, 0x00},
	{ CDC_VA_ADPT3_ADPT_CTRL, 0x51},
	{ CDC_VA_ADPT3_ADPT_GAIN_0, 0x11},
	{ CDC_VA_ADPT3_ADPT_GAIN_1, 0x01},
	{ CDC_VA_ADPT3_DH_FSM_CTRL, 0x02},
	{ CDC_VA_ADPT3_CUTOFF_FSM_CTRL_0, 0x77},
	{ CDC_VA_ADPT3_CUTOFF_FSM_CTRL_1, 0x01},
	{ CDC_VA_ADPT3_CUTOFF_FSM_CTRL_2, 0x64},
	{ CDC_VA_ADPT3_CUTOFF_FSM_CTRL_3, 0x00},
	{ CDC_VA_ADPT3_CUTOFF_FSM_CTRL_4, 0x41},
	{ CDC_VA_ADPT3_CUTOFF_FSM_CTRL_5, 0x04},
	{ CDC_VA_ADPT3_CUTOFF_FSM_CTRL_6, 0x01},
	{ CDC_VA_ADPT3_DBG_CTRL, 0x00},
	{ CDC_VA_ADPT3_DBG_PDM_RATE_CTRL_0, 0x45},
	{ CDC_VA_ADPT3_DBG_PDM_RATE_CTRL_1, 0x01},
	{ CDC_VA_ADPT3_SPARE0, 0x00},
	{ CDC_VA_INTR_CTRL_CFG, 0x00},
	{ CDC_VA_INTR_CTRL_CLR_COMMIT, 0x00},
	{ CDC_VA_INTR_CTRL_PIN1_MASK0, 0xFF},
	{ CDC_VA_INTR_CTRL_PIN1_STATUS0, 0x00},
	{ CDC_VA_INTR_CTRL_PIN1_CLEAR0, 0x00},
	{ CDC_VA_INTR_CTRL_PIN2_MASK0, 0xFF},
	{ CDC_VA_INTR_CTRL_PIN2_STATUS0, 0x00},
	{ CDC_VA_INTR_CTRL_PIN2_CLEAR0, 0x00},
	{ CDC_VA_INTR_CTRL_LEVEL0, 0x00},
	{ CDC_VA_INTR_CTRL_BYPASS0, 0x00},
	{ CDC_VA_INTR_CTRL_SET0, 0x00},
};
...
static bool va_is_rw_register(struct device *dev, unsigned int reg)
{
	...
	case CDC_VA_ADPT0_ADPT_CTRL:
	case CDC_VA_ADPT0_ADPT_GAIN_0:
	case CDC_VA_ADPT0_ADPT_GAIN_1:
	case CDC_VA_ADPT0_DH_FSM_CTRL:
	case CDC_VA_ADPT0_CUTOFF_FSM_CTRL_0:
	case CDC_VA_ADPT0_CUTOFF_FSM_CTRL_1:
	case CDC_VA_ADPT0_CUTOFF_FSM_CTRL_2:
	case CDC_VA_ADPT0_CUTOFF_FSM_CTRL_3:
	case CDC_VA_ADPT0_CUTOFF_FSM_CTRL_4:
	case CDC_VA_ADPT0_CUTOFF_FSM_CTRL_5:
	case CDC_VA_ADPT0_CUTOFF_FSM_CTRL_6:
	case CDC_VA_ADPT0_DBG_CTRL:
	case CDC_VA_ADPT0_DBG_PDM_RATE_CTRL_0:
	case CDC_VA_ADPT0_DBG_PDM_RATE_CTRL_1:
	case CDC_VA_ADPT0_SPARE0:
	case CDC_VA_ADPT1_ADPT_CTRL:
	case CDC_VA_ADPT1_ADPT_GAIN_0:
	case CDC_VA_ADPT1_ADPT_GAIN_1:
	case CDC_VA_ADPT1_DH_FSM_CTRL:
	case CDC_VA_ADPT1_CUTOFF_FSM_CTRL_0:
	case CDC_VA_ADPT1_CUTOFF_FSM_CTRL_1:
	case CDC_VA_ADPT1_CUTOFF_FSM_CTRL_2:
	case CDC_VA_ADPT1_CUTOFF_FSM_CTRL_3:
	case CDC_VA_ADPT1_CUTOFF_FSM_CTRL_4:
	case CDC_VA_ADPT1_CUTOFF_FSM_CTRL_5:
	case CDC_VA_ADPT1_CUTOFF_FSM_CTRL_6:
	case CDC_VA_ADPT1_DBG_CTRL:
	case CDC_VA_ADPT1_DBG_PDM_RATE_CTRL_0:
	case CDC_VA_ADPT1_DBG_PDM_RATE_CTRL_1:
	case CDC_VA_ADPT1_SPARE0:
	case CDC_VA_ADPT2_ADPT_CTRL:
	case CDC_VA_ADPT2_ADPT_GAIN_0:
	case CDC_VA_ADPT2_ADPT_GAIN_1:
	case CDC_VA_ADPT2_DH_FSM_CTRL:
	case CDC_VA_ADPT2_CUTOFF_FSM_CTRL_0:
	case CDC_VA_ADPT2_CUTOFF_FSM_CTRL_1:
	case CDC_VA_ADPT2_CUTOFF_FSM_CTRL_2:
	case CDC_VA_ADPT2_CUTOFF_FSM_CTRL_3:
	case CDC_VA_ADPT2_CUTOFF_FSM_CTRL_4:
	case CDC_VA_ADPT2_CUTOFF_FSM_CTRL_5:
	case CDC_VA_ADPT2_CUTOFF_FSM_CTRL_6:
	case CDC_VA_ADPT2_DBG_CTRL:
	case CDC_VA_ADPT2_DBG_PDM_RATE_CTRL_0:
	case CDC_VA_ADPT2_DBG_PDM_RATE_CTRL_1:
	case CDC_VA_ADPT2_SPARE0:
	case CDC_VA_ADPT3_ADPT_CTRL:
	case CDC_VA_ADPT3_ADPT_GAIN_0:
	case CDC_VA_ADPT3_ADPT_GAIN_1:
	case CDC_VA_ADPT3_DH_FSM_CTRL:
	case CDC_VA_ADPT3_CUTOFF_FSM_CTRL_0:
	case CDC_VA_ADPT3_CUTOFF_FSM_CTRL_1:
	case CDC_VA_ADPT3_CUTOFF_FSM_CTRL_2:
	case CDC_VA_ADPT3_CUTOFF_FSM_CTRL_3:
	case CDC_VA_ADPT3_CUTOFF_FSM_CTRL_4:
	case CDC_VA_ADPT3_CUTOFF_FSM_CTRL_5:
	case CDC_VA_ADPT3_CUTOFF_FSM_CTRL_6:
	case CDC_VA_ADPT3_DBG_CTRL::
	case CDC_VA_ADPT3_DBG_PDM_RATE_CTRL_0:
	case CDC_VA_ADPT3_DBG_PDM_RATE_CTRL_1:
	case CDC_VA_ADPT3_SPARE0:
	case CDC_VA_INTR_CTRL_CFG:
	case CDC_VA_INTR_CTRL_CLR_COMMIT:
	case CDC_VA_INTR_CTRL_PIN1_MASK0:
	case CDC_VA_INTR_CTRL_PIN1_STATUS0:
	case CDC_VA_INTR_CTRL_PIN1_CLEAR0:
	case CDC_VA_INTR_CTRL_PIN2_MASK0:
	case CDC_VA_INTR_CTRL_PIN2_STATUS0:
	case CDC_VA_INTR_CTRL_PIN2_CLEAR0:
	case CDC_VA_INTR_CTRL_LEVEL0:
	case CDC_VA_INTR_CTRL_BYPASS0:
	case CDC_VA_INTR_CTRL_SET0:
		return true;
	}
